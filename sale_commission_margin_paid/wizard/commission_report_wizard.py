...
class CommissionReportWizard(models.TransientModel):
    ...
    commission_type = fields.Selection(
        selection=[
            ("paid", "Paid Invoices"),
            ("posted", "Posted Invoices (Not Paid)"),
        ],
        string="Commission Type",
        required=True,
        default="paid",
        help=(
            "Paid Invoices: calculate commissions only for invoices that have "
            "been fully collected (payment_state = paid).\n"
            "Posted Invoices: calculate commissions for all posted invoices "
